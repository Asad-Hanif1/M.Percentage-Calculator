...
var DrawingMarks = document.querySelector('#dra-marks');
...
function calculatePercentage(){
    ...
    console.log(DrawingMarks.value);
    
    var totalMarks = 900;
    var obtainedMarks = +ChemMarks.value + +EngMarks.value + +ComMarks.value + +SSTMarks.value + +SciMarks.value + +IslMarks.value + +UrduMarks.value + +SindhiMarks.value + +DrawingMarks.value;
